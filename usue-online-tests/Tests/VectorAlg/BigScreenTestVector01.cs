...
//{
//    public class BigScrTestVactorA01 : ITestCreator, ITest, ITimeLimit
//    {
//        public int TestID { get; set; }
//        public string Name { get; } = "Координаты вектора по двум точкам 01";
//        public string Description { get; } = "Vectors Algebra";
//        public class Data
//        {
...
//                CreatePlane(random);
//            }
//            public void CreatePlane(Random random)
//            {
...
//            return new BigScrTestVactorA01
//            {
//                Text = string.Empty,
