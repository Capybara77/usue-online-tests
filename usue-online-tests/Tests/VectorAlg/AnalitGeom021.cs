...
{
    public class AnalitGeom021 : ITestCreator, ITest, ITimeLimit, IHidden, ITestGroup
    {
        public int TestID { get; set; }
        public string GroupName { get; set; } = "Analitic Geometry and Vectors";
        public string Name { get; } = "Аналитическая геометрия 021";
