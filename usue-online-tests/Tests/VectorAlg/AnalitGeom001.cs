...
{
    public class AnalitGeom001 : ITestCreator, ITest, ITimeLimit, IHidden, ITestGroup
    {
        int answer1;
        int answer2;
        int answer3;
        ...
        public ITest CreateTest(int randomSeed)
        {
            ...
            vectorEndX = vectorStartX + 30 * h1;
            vectorEndY = vectorStartY - 30 * h2;
            ...
            pointAx = centerX - 30 * random.Next(2, 4);
            pointAy = centerY + 30 * random.Next(2, 4);
            if ((-8 + pointAx / 30) == (8 - pointAy / 30))
                pointAy = centerY + 30 * (-1 + pointAx / 30);
